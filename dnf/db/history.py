...
class SwdbInterface(object):
    ...
    @property
    def dbpath(self):
        return os.path.join(self._db_dir, libdnf.swdb.Swdb.defaultDatabaseName)
    ...
    def swdb(self):
        ...
        if not self._swdb:
            ...
            self._swdb = libdnf.swdb.Swdb(self.dbpath)
            # TODO: vars -> libdnf
        return self._swdb

    def transform(self, input_dir):
        transformer = libdnf.swdb.Transformer(input_dir, self.dbpath)
